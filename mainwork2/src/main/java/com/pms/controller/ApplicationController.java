...
public class ApplicationController {
	 ...
	 * request.setAttribute("mode", "MODE_UPDATE"); return "welcomepage"; }
	 */
...
//	}
	...
	
	{
	 ...
	 @RequestMapping( value="/after-login", method = RequestMethod.GET) 
		 public String afterLogin(@ModelAttribute User user, HttpServletRequest request) 
	 
	 {
	  ...
	  @GetMapping("/top-report")
	  public ModelAndView StateWiseDataSC1(ModelAndView modelAndView, @RequestParam(defaultValue = "0") Integer pageNo,@RequestParam(defaultValue = "5") Integer pageSize, @RequestParam(defaultValue = "totalRecord") String sortBy) 
	  
	  {
	  
	  List<StateWiseDataSC> stateWiseDataSCList =userService.getAllTopState(pageNo,pageSize, sortBy);
	  
	  System.out.println("in StateWiseDataSC method of ApplicationController--stateWiseDataSCList size is =="+stateWiseDataSCList.size());
	  modelAndView.addObject("mode", "MODE_TOPR");
	  modelAndView.addObject("stateWiseDataSCs",stateWiseDataSCList);
	  modelAndView.setViewName("topreport"); 
	  return modelAndView ;
	  ...
	  @GetMapping("/top-report1") 
	  public ModelAndView StateWiseDataSC2(ModelAndView modelAndView, @RequestParam(defaultValue = "0")
	  Integer pageNo,@RequestParam(defaultValue = "5") Integer pageSize, @RequestParam(defaultValue = "totalRecordMale") String sortBy)
	  
	  {
	  
	  List<StateWiseDataSC> stateWiseDataSCList=userService.getAllTopState1(pageNo,pageSize, sortBy);
	  
	  System.out.println("in StateWiseDataSC method of ApplicationController--stateWiseDataSCList size is =="+stateWiseDataSCList.size());
	  modelAndView.addObject("mode", "MODE_TOPRM");
	  modelAndView.addObject("stateWiseDataSCs",stateWiseDataSCList);
	  modelAndView.setViewName("topreport"); 
	  return modelAndView ;
